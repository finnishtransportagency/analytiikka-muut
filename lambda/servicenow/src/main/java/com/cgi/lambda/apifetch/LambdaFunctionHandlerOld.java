...
public class LambdaFunctionHandlerOld implements RequestHandler<Object, String> {
	...
	private EnrichServiceNowDataWithCoordinatesOld enrichmentCenter;
	...
	public String handleRequest(Object input, Context context) {
		...
		if(!data.isEmpty()) {
			...
			try {
				enrichmentCenter = new EnrichServiceNowDataWithCoordinatesOld(context,data,"EPSG:3067",Integer.parseInt(slimit)); //3067 =ETRS89 / ETRS-TM35FIN, converts to 4326=wgs84
